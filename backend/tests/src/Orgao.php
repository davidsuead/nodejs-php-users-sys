...
/**
 * Classe de teste Funcionalidade Órgãos
 * PSGO007_Manter_Orgãos
 */
...
class Orgao extends PHPUnit_Framework_TestCase {
    ...
    public function testFE001NenhumRegistroEncontrado() {
        try {
            ...
            sleep(3);
            $this->webDriver->get($this->configuration->urlSistema() . "admin/orgao");
    ...
    public function testFE002CamposObrigatoriosNaoPreenchidos() {
        try {
            ...
            sleep(3);
            $msg = trim($this->webDriver->findElement(WebDriverBy::id("siglPrestadorServicoMsgError"))->getText());
    ...
    /**
     * [FA004] – Cadastrar Novo Órgão.
     */
    public function testFA004CadastroNovoOrgaoSucesso() {
        try {
            // Acessa o sistema.
            $this->configuration->login();
            sleep(3);
            ...
            $this->webDriver->findElement(WebDriverBy::className("introjs-skipbutton"))->click();
            // Sigla do Órgão
            $this->webDriver->findElement(WebDriverBy::id("siglPrestadorServico"))->sendKeys('OR1');
            // Nome do Órgão
            $this->webDriver->findElement(WebDriverBy::id("nomePrestadorServico"))->sendKeys('Teste Automatizado 1');
            // Descrição do Órgão
...
END_JAVASCRIPT;
    ...
    /**
     * [FE004] – Nome de Órgão Duplicado.
     */
    public function testFE004NomeDeOrgaoDuplicado() {
        try {
            // Acessa o sistema.
            $this->configuration->login();
            sleep(3);
...
END_JAVASCRIPT;
            ...
            $this->webDriver->findElement(WebDriverBy::xpath("//a[@class='btn btn-success pull-right btnSalvar']"))->click();
            sleep(3);
            $msg = trim($this->webDriver->findElement(WebDriverBy::id("nomePrestadorServicoMsgError"))->getText());
    ...
    /**
     *  [FE006] – Sigla do Órgão Duplicada.
     */
    public function testFE006SiglaDoOrgaoDuplicada() {
        try {
            // Acessa o sistema.
            $this->configuration->login();
            sleep(3);
...
END_JAVASCRIPT;
            ...
            sleep(3);
            $msg = trim($this->webDriver->findElement(WebDriverBy::id("siglPrestadorServicoMsgError"))->getText());
            $this->assertEquals(preg_match('/Já possui um registro com esta sigla/', $msg), 1);
            // Sair do sistema.
            $this->configuration->logout();
        } catch (\Exception $e) {
            throw($e);
    ...
    public function testFA001PesquisarRegistro() {
        try {
            ...
            sleep(3);
            // Nome do Órgão
            $this->webDriver->findElement(WebDriverBy::id("nomePrestadorServico"))->sendKeys('automatizado');
            sleep(2);
    ...
    public function testFA009LimparDadosDoFiltro() {
        try {
            ...
            sleep(2);
            $dados = $this->webDriver->findElement(WebDriverBy::id("nomePrestadorServico"))->getAttribute('value');
    ...
    public function testFA005EditarOrgao() {
        try {
            ...
            $this->webDriver->findElement(WebDriverBy::className("introjs-skipbutton"))->click();
            // Sigla do Órgão
            $this->webDriver->findElement(WebDriverBy::id("siglPrestadorServico"))->sendKeys(' - ALT');
            // Nome do Órgão
            $this->webDriver->findElement(WebDriverBy::id("nomePrestadorServico"))->sendKeys(' - Alterado');
            // Descrição do Órgão
            $javascript = <<<END_JAVASCRIPT
...
END_JAVASCRIPT;
    ...
    public function testFA005RegistroComDependencia() {
        require_once 'criarDependenciaOrgao.php';
        try {
            // Acessa o sistema.
            $this->configuration->login();
            sleep(3);
            ...
            require_once 'limparDependenciaOrgao.php';
            // Sair do sistema.
            $this->configuration->logout();
        } catch (\Exception $e) {
            throw($e);
