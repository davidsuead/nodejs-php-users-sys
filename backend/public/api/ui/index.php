...
if (!isset($_SERVER['APP_ENV'])) {
    ...
    if ($database->APP_AMBIENTE == 'desenv') {
        (new Symfony\Component\Dotenv\Dotenv())->load(__DIR__ . '/../../../.env_des');
    } elseif ($database->APP_AMBIENTE == 'test') {
        error_reporting(0);
        (new Symfony\Component\Dotenv\Dotenv())->load(__DIR__ . '/../../../.env_test');
    } elseif ($database->APP_AMBIENTE == 'homolog') {
        error_reporting(0);
        (new Symfony\Component\Dotenv\Dotenv())->load(__DIR__ . '/../../../.env_hom');
    } else {
        error_reporting(0);
